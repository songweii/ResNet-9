...
class Trainer:
    def __init__(self, model, x_train, t_train, num_classes, init_lr, batch_size, train_size, beta1=0.9, beta2=0.999):
        self.net = model
    ...
    def iterate(self):
        ...
        self.net.backward(out_diff_tensor, lr_t, beta1=self.beta1, beta2=self.beta2)
...
if __name__ == '__main__':
    ...
    filepath = os.path.join(dir, 'adam_training_history.pkl')
    picpath = os.path.join(dir, 'adam_loss_accuracy_curve.png')
